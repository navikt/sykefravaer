    ...
    <article>
        <div className="panel blokk dine-opplysninger">
            ...
            <div className="blokk-l side-innhold">
                ...
                <Hoveddiagnose hoveddiagnose={smSykmelding.medisinskVurdering && smSykmelding.medisinskVurdering.diagnose} />
                <BiDiagnoser biDiagnoser={smSykmelding.medisinskVurdering && smSykmelding.medisinskVurdering.biDiagnoser} sykmeldingId={smSykmelding.id} />
                <Nokkelopplysning
