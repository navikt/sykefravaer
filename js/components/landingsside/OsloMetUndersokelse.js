...
const mapStateToProps = (state) => {
    ...
    const FEMTISJU_DAGER_SIDEN = new Date(DAGENS_DATO);
    FEMTISJU_DAGER_SIDEN.setDate(DAGENS_DATO.getDate() - 57);
    const TJUESJU_DAGER_SIDEN = new Date(DAGENS_DATO);
    ...
    const vis = (() => {
        ...
        return harAktivSykmelding
            && oppfoelgingsdato < TJUESJU_DAGER_SIDEN
            && oppfoelgingsdato > FEMTISJU_DAGER_SIDEN;
    })();
