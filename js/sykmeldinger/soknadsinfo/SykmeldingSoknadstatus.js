...
export const PapirsoknadMelding = () => {
    return (
        <IllustrertInnhold ikon={`${process.env.REACT_APP_CONTEXT_ROOT}/img/svg/digital-til-papir.svg`} ikonAlt="">
...
export const SokOmSykepengerNaa = ({ sykepengesoknad }) => {
    return (
        <IllustrertInnhold ikon={`${process.env.REACT_APP_CONTEXT_ROOT}/img/svg/kvitteringSokSykepenger.svg`} ikonAlt="Søk om sykepenger">
            <div>
...
export const SoknadSendtBekreftelse = () => {
    return (
        <IllustrertInnhold ikon={`${process.env.REACT_APP_CONTEXT_ROOT}/img/svg/sykepengesoknad--sendt.svg`} ikonAlt="Dataskjerm med hake">
            <div>
...
export const SoknadAvbruttBekreftelse = ({ sykepengesoknad }) => {
    return (
        <IllustrertInnhold ikon={`${process.env.REACT_APP_CONTEXT_ROOT}/img/svg/sykepengesoknad--avbrutt.svg`} ikonAlt="Dataskjerm med utropstegn">
            <div>
...
export const UtgaattSoknadBekreftelse = () => {
    return (
        <IllustrertInnhold ikon={`${process.env.REACT_APP_CONTEXT_ROOT}/img/svg/sykepengesoknad--utgaatt.svg`} ikonAlt="Dataskjerm med utropstegn">
            <div>
