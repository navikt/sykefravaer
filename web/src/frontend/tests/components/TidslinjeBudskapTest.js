...
describe("TidslinjeBudskap", () => {
    ...
    it("Skal vise bilde dersom det finnes bilde", () => {
        ...
        expect(html).to.deep.equal({
            __html: '<div class=\"side-innhold boble-budskap\"><img class=\"js-img\" alt=\"\" src=\"Olsen.jpg\" /> Olsen</div>'
        });
    });
    ...
    it("Skal vise alt-tekst dersom det finnes bilde og alt-tekst", () => {
        ...
        expect(html).to.deep.equal({
            __html: '<div class=\"side-innhold boble-budskap\"><img class=\"js-img\" alt=\"Mr. Olsen\" src=\"Olsen.jpg\" /> Olsen</div>'
        });
    })
    ...
    it("Skal ikke vise bilde dersom det ikke finnes bilde", () => {
        ...
        expect(html).to.deep.equal({
            __html: '<div class=\"side-innhold boble-budskap\">Hansen</div>'
        });
    })
