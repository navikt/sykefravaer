...
import AktiviteterISykmeldingsperioden from '../../components/sykepenger/AktiviteterISykmeldingsperioden/AktiviteterISykmeldingsperioden';

export const Container = (props) => {
    const { brodsmuler } = props;
    return (<Side tittel="Søknad om sykepenger" brodsmuler={brodsmuler}>
        <AktiviteterISykmeldingsperioden />
    </Side>);
};
