import * as actions from '../../js/data/sykepengesoknader/sykepengesoknader_actions';
import sykepengesoknader from '../../js/data/sykepengesoknader/sykepengesoknader';
...
export const getParsetSoknad = (soknad = {}) => Object.assign({}, {
    id: '66a8ec20-b813-4b03-916f-7a2f0751b600',
    status: 'NY',
    innsendtDato: null,
