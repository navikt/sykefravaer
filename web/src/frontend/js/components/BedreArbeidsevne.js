...
const BedreArbeidsevne = ({ sykmelding, ledetekster }) => {
	return (<div>
                {
                    sykmelding.tilretteleggingArbeidsplass || sykmelding.tiltakNAV || sykmelding.tiltakAndre ? <h4 className="sykmelding-seksjonstittel">Hva skal til for å bedre arbeidsevnen?</h4> : ''
                }
                {
