...
import { getSykepengesoknadSkjemanavn } from '../../js/enums/skjemanavn';
...
describe('mapStateToProps', () => {
    ...
    beforeEach(() => {
        state = {
            form: {
                [getSykepengesoknadSkjemanavn('soknad-id')]: {
                    values: {
    ...
    it('Skal returnere null hvis harGjenopptattArbeidFulltUt er false og gjenopptattArbeidFulltUtDato er riktig fylt ut', () => {
        state.form[getSykepengesoknadSkjemanavn('soknad-id')].values.harGjenopptattArbeidFulltUt = false;
        state.form[getSykepengesoknadSkjemanavn('soknad-id')].values.gjenopptattArbeidFulltUtDato = '20.02.2017';
    ...
    it('Skal returnere gjenopptattArbeidFulltUtDato = null hvis gjenopptattArbeidFulltUtDato er noe ugyldig (1)', () => {
        state.form[getSykepengesoknadSkjemanavn('soknad-id')].values.gjenopptattArbeidFulltUtDato = '02.02';
        const props = mapStateToProps(state, ownProps);
        expect(props.gjenopptattArbeidFulltUtDato).to.equal(null);
    });

    it('Skal returnere gjenopptattArbeidFulltUtDato = null hvis gjenopptattArbeidFulltUtDato er en ugyldig streng (1)', () => {
        state.form[getSykepengesoknadSkjemanavn('soknad-id')].values.gjenopptattArbeidFulltUtDato = '0_.__.____';
        const props = mapStateToProps(state, ownProps);
        expect(props.gjenopptattArbeidFulltUtDato).to.equal(null);
    });

    it('Skal returnere gjenopptattArbeidFulltUtDato = null hvis gjenopptattArbeidFulltUtDato er en ugyldig streng (2)', () => {
        state.form[getSykepengesoknadSkjemanavn('soknad-id')].values.gjenopptattArbeidFulltUtDato = '10.__.____';
        const props = mapStateToProps(state, ownProps);
        expect(props.gjenopptattArbeidFulltUtDato).to.equal(null);
    });

    it('Skal returnere gjenopptattArbeidFulltUtDato = null hvis gjenopptattArbeidFulltUtDato er en ugyldig streng (3)', () => {
        state.form[getSykepengesoknadSkjemanavn('soknad-id')].values.gjenopptattArbeidFulltUtDato = '10.05.____';
        const props = mapStateToProps(state, ownProps);
        expect(props.gjenopptattArbeidFulltUtDato).to.equal(null);
    });
    ...
    it('Skal returnere gjenopptattArbeidFulltUtDato = null hvis gjenopptattArbeidFulltUtDato er noe gyldig', () => {
        state.form[getSykepengesoknadSkjemanavn('soknad-id')].values.gjenopptattArbeidFulltUtDato = '23.12.2017';
        const props = mapStateToProps(state, ownProps);
