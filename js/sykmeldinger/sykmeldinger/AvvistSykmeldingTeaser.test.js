...
describe('Avvist sykmelding teaser', () => {
    ...
    describe('ledetekst for periode', () => {
        it('skal finne riktig ledetekst for periode med aktivitet ikke mulig', () => {
            ...
            expect(actualLedetekst).to.equal('sykmelding.teaser.tekst.uten-arbeidsgiver');
        });
        ...
        it('skal finne riktig ledetekst for periode med en behandlingsdag', () => {
            ...
            expect(actualLedetekst).to.equal('sykmelding.teaser.tekst.behandlingsdag.uten-arbeidsgiver.ingen-grad');
        });
        ...
        it('skal finne riktig ledetekst for periode med flere behandlingsdager', () => {
            ...
            expect(actualLedetekst).to.equal('sykmelding.teaser.tekst.behandlingsdager.uten-arbeidsgiver.ingen-grad');
        });
        ...
        it('skal finne riktig ledetekst for periode som er avventende', () => {
            ...
            expect(actualLedetekst).to.equal('sykmelding.teaser.tekst.avventende.uten-arbeidsgiver.ingen-grad');
        });
    });
});
