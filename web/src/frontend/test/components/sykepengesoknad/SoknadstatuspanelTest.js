...
describe("Soknadstatuspanel", () => {
    ...
    describe("Når søknaden sendes til NAV", () => {
        ...
        it("Skal vise info om sykepenger", () => {
            expect(component.html()).to.contain('Sykepenger utbetales etter at NAV har innvilget søknaden. <a href="test" target="_blank">Les om sykepenger og saksbehandlingstider.</a>');
        });
    ...
    describe("Når søknaden sendes til arbeidsgiver", () => {
        ...
        it("Skal vise Sender...", () => {
            expect(component.text()).to.contain("Sender til BYGGMESTER BLOM AS (org. nr. 983 610 218)...");
        });
    ...
    describe("Når søknaden sendes til arbeidsgiver og NAV", () => {
        ...
        it("Skal vise Sender...", () => {
            expect(component.text()).to.contain("Sender til NAV og BYGGMESTER BLOM AS (org. nr. 983 610 218)...");
        });
