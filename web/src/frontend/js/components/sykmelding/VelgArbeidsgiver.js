...
const VelgArbeidsgiver = ({ arbeidsgivere, ledetekster, sykmelding, skjemaData, pilotSykepenger }) => {
    ...
    return (<div>
        ...
        {
            pilotSykepenger && values.valgtArbeidsgiver && values.valgtArbeidsgiver.orgnummer !== '0' &&
                <ForskuttererArbeidsgiver arbeidsgiver={values.valgtArbeidsgiver} skjemaData={skjemaData} ledetekster={ledetekster} />
        }
    </div>);
};
