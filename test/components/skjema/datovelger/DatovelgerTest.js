...
import Datovelger, { DatoField, genererValidate } from '../../../../js/components/skjema/datovelger/Datovelger';
import { formaterEnkeltverdi, genererParseForEnkeltverdi } from '../../../../js/utils/fieldUtils';
...
describe('Datovelger', () => {
    ...
    describe('Datovelger', () => {
        ...
        it('Skal sende en validerFoerDuBegynner-funksjon videre til Field', () => {
            expect(typeof component.find(Field)
                .prop('validate'))
                .to
                .equal('function');
        });
    ...
    describe('DatoField', () => {
        ...
        it('Skal inneholde et MaskedInput-felt med riktig ID', () => {
            expect(component.find('MaskedInput#olsen[type="tel"]'))
                .to
                .have
                .length(1);
        });
        ...
        describe('validate', () => {
            ...
            it('Skal klage hvis datoformatet er ugyldig', () => {
                ...
                expect(feilmelding)
                    .to
                    .equal('Datoen må være på formatet dd.mm.åååå');
            });
            ...
            it('Skal klage hvis datoen er etter senesteTom', () => {
                ...
                expect(feilmelding)
                    .to
                    .equal('Datoen må være innenfor perioden 1. – 5. januar 2018');
            });
