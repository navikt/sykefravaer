...
import { Sporsmal, visSoktOmSykepengerUtenlandsoppholdsporsmal, mergePerioder } from '../../../../js/components/sykepengesoknad/FravaerOgFriskmelding/SoktOmSykepengerIUtenlandsopphold';
...
describe("SoktOmSykepenger", () => {
  ...
  describe("visSoktOmSykepengerUtenlandsoppholdsporsmal", () => {
    it("Skal funke hvis periodene ikke er komplette", () => {
      ...
      expect(visSoktOmSykepengerUtenlandsoppholdsporsmal(deepFreeze(values))).to.be.false;
    });
    ...
    it("Skal returnere true hvis det er utenlandsopphold som går over mer enn en helg", () => {
      ...
      expect(visSoktOmSykepengerUtenlandsoppholdsporsmal(deepFreeze(values))).to.be.true;
    });
