...
import { arbeidssituasjoner, setLedetekster } from 'digisyfo-npm';
import VelgArbeidssituasjon, { getAlternativer, RendreVelgArbeidssituasjon, Velg } from '../../../js/components/sykmeldingskjema/VelgArbeidssituasjon';
...
import { SkrivUt } from '../../../js/components/sykmeldingskjema/VelgArbeidsgiver';
...
describe('VelgArbeidssituasjon', () => {
    ...
    describe('Velg', () => {
        ...
        it('Skal vise SkrivUt hvis arbeidssituasjon er ARBEIDSTAKER', () => {
            props.input.value = arbeidssituasjoner.ARBEIDSTAKER;
            component = shallow(<Velg {...props} />);
            expect(component.find(SporsmalMedTillegg).find(SkrivUt)).to.have.length(1);
        });
