...
export const genererHandleAddition = (meta, input, doAutofill, tagliste = []) => {
...
const LandvelgerComponent = ({ input, meta, doAutofill }) => {
...
const Landvelger = connect(null, { doAutofill: autofill })(LandvelgerComponent);
