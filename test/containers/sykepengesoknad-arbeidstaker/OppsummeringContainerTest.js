...
import {
    ...
    utledMottaker,
} from '../../../js/containers/sykepengesoknad-arbeidstaker/OppsummeringContainer';
...
import mapSkjemasoknadToOppsummeringsoknad from '../../../js/components/sykepengesoknad-arbeidstaker/mappers/mapSkjemasoknadToOppsummeringsoknad';
...
describe('OppsummeringContainer', () => {
    ...
    describe('Oppsummering', () => {
        ...
        describe('routerWillLeave', () => {
            ...
            it('Skal returnere null hvis sykepengesoknad-felles-felles-arbeidstaker-arbeidstaker-arbeidstaker-arbeidstaker ikke er NY', () => {
            ...
            it('Skal returnere streng hvis sykepengesoknad-felles-felles-arbeidstaker-arbeidstaker-arbeidstaker-arbeidstaker er UTKAST_TIL_KORRIGERING', () => {
