...
describe('DineSykmeldingerContainer', () => {
    ...
    describe('DineSykmldSide', () => {
        ...
        it('Skal hente sykmeldinger hvis sykmeldinger ikke er hentet', () => {
            shallow(<DineSykmldSide hentDineSykmeldinger={hentDineSykmeldinger} sykmeldinger={[]} sykmeldingerHentet={false} dispatch={dispatch} />);
            expect(hentDineSykmeldinger.calledOnce).to.equal(true);
        });

        it('Skal ikke hente sykmeldinger hvis sykmeldinger er hentet', () => {
            shallow(<DineSykmldSide hentDineSykmeldinger={hentDineSykmeldinger} sykmeldinger={[]} sykmeldingerHentet dispatch={dispatch} />);
            expect(hentDineSykmeldinger.calledOnce).to.equal(false);
        });

        it('Skal vise spinner dersom data hentes', () => {
            const component = shallow(<DineSykmldSide hentDineSykmeldinger={hentDineSykmeldinger} sykmeldinger={[]} henter dispatch={dispatch} />);
            expect(component.contains(<AppSpinner />)).to.equal(true);
        });

        it('Skal ikke spinner dersom data ikke hentes', () => {
            const component = shallow(<DineSykmldSide hentDineSykmeldinger={hentDineSykmeldinger} sykmeldinger={[]} dispatch={dispatch} />);
            expect(component.contains(<AppSpinner />)).to.equal(false);
        });

        it('Skal vise feilmelding dersom henting feilet', () => {
            const component = shallow(<DineSykmldSide hentDineSykmeldinger={hentDineSykmeldinger} sykmeldinger={[]} dispatch={dispatch} hentingFeilet />);
